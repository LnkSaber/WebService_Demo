 ...
 * 
 */
@WebServiceClient(name = "HelloServiceImplService", targetNamespace = "http://Impl.service.saber.com/", wsdlLocation = "http://localhost:8081/WebService/service/cxfService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICEIMPLSERVICE_QNAME = new QName("http://Impl.service.saber.com/", "HelloServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/WebService/service/cxfService?wsdl");
    ...
    public HellowService getHelloServiceImplPort() {
        return super.getPort(new QName("http://Impl.service.saber.com/", "HelloServiceImplPort"), HellowService.class);
    }
     ...
     */
    @WebEndpoint(name = "HelloServiceImplPort")
    public HellowService getHelloServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Impl.service.saber.com/", "HelloServiceImplPort"), HellowService.class, features);
    }
